...
def main():
    ...
    ui_p = sub.add_parser("ui", help="Launch a Gradio UI")
    ui_p.add_argument("--host", default="0.0.0.0", help="Host to bind")
    ui_p.add_argument("--port", type=int, default=7860, help="Port to bind")
    ui_p.add_argument("--share", action="store_true", help="Enable Gradio share link")
    ...
    if args.cmd == "ui":
        ...
        from autofs_vnext.ui import launch
